...
def search1(request):
    ...
    return render(request, 'listings/_partials/_searchPriceOne.html', context)
...
def search2(request):
    ...
    return render(request, 'listings/_partials/_searchPriceTwo.html', context)
...
def search3(request):
    ...
    return render(request, 'listings/_partials/_searchPriceThree.html', context)
